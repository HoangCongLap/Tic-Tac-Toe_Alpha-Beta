...
public class Board {
    ...
    /**
     * Khởi động lại trò chơi với một bảng trống mới.   playersTurn = State.X;(người sẽ là X )
     */
    void reset () {
        moveCount = 0;
        gameOver = false;
     ...
     * @param index    chỉ số vị trí trên bảng (ví dụ: index 4 là vị trí (index % BOARD_WIDTH=1, index / BOARD_WIDTH=1 )(4%3=1, 4/3=1))
    ...
    /**
     * Kiểm tra hàng được chỉ định để xem có người chiến thắng hay không.
    ...
    /**
     * Kiểm tra cột được chỉ định để xem có người chiến thắng hay không.
    ...
    /**
     * Kiểm tra đường chéo bên trái để xem có người chiến thắng không.
     * @param x        x tọa độ x của nước đi được chơi gần đây nhất
     * @param y        y tọa độ y của nước đi được chơi gần đây nhất
     */
    ...
    /**
     * Kiểm tra đường chéo bên phải để xem có người chiến thắng không.
