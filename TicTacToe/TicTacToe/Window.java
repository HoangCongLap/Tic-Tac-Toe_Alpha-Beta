...
public class Window extends JFrame {
    ...
    /**
     * Đặt kích thước, tiêu đề, khả năng hiển thị, v.v ...
     */
    private void setWindowProperties() {
        setResizable(false);
        pack();
        setTitle("FAN MU's_Tic Tac Toe");
    ...
    /**
     * Tải hình ảnh của nền và hình ảnh của X và O
     * thay đổi tên ảnh "x.png","0.png","background.png"
     */
     ...
     *
     * @param path đường dẫn tên của hình ảnh
     * @return trả ra hình ảnh đã được lấy
     */
